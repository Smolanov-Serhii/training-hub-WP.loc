...
function dimox_breadcrumbs() {
    ...
    $wrap_before    = '<ol class="breadcrumb"><i class="fa fa-home"></i>'; // открывающий тег обертки
...
//    $sep            = '<span class="breadcrumbs__separator"> › </span>'; // разделитель между "крошками"
    ...
    $home_icon      = '<i class="fa fa-home"></i>'; //иконка перед домом
    ...
    if ( is_home() || is_front_page() ) {
        ...
        if ( $show_on_home ) echo $wrap_before . $home_icon . $home_link . $wrap_after;
